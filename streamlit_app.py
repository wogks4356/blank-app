...
if st.session_state.page == "home":
    ...
    with col2:
        ...
        st.markdown(
            """
            <a href="#" onclick="window.location.reload(); document.getElementById('page_state').value = 'csv';">
                <img src="https://mblogthumb-phinf.pstatic.net/MjAyNDAyMjNfMjU1/MDAxNzA4NjE2NTAyODUx.Yz14QKhzSHdt-3JVbYCp5RP15Zhq5nhOZwaWJRLaqmMg.WeALWGNC-3Ry0yXiyhhtByGiaJTSC8JDkc_LWIVhEyUg.PNG/SE-4ebe176a-47fb-4d74-844c-39ec26681e52.png?type=w800" class="clickable-image" alt="사레레">
            </a>
            """,
            unsafe_allow_html=True,
        )
    ...
    with col3:
        ...
        st.markdown(
            """
            <a href="#" onclick="window.location.reload(); document.getElementById('page_state').value = 'csv';">
                <img src="https://blog.kakaocdn.net/dn/dSw3lH/btq54MXF9Rl/nDVQ5JhPbMq5RRMRvpFHS0/img.png" class="clickable-image" alt="이두">
            </a>
            """,
            unsafe_allow_html=True,
        )
