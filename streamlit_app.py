...
if st.session_state.page == "start":
    ...
    with col1:
        ...
        if st.button("https://w7.pngwing.com/pngs/928/451/png-transparent-muscle-emoji-emoji-pop-sticker-biceps-smiley-muscle-hand-arm-thumb-thumbnail.png 삼두 페이지로 이동"):
            set_page("csv")
